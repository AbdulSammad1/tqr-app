...
import 'package:tqrfamily_bysaz_flutter/publicity/model/p_inprocess_model.dart';
...
import '../conrtroller/pub_inprocess_controller.dart';

class PubInProcessScreen extends StatefulWidget {
  const PubInProcessScreen({Key? key}) : super(key: key);

  @override
  State<PubInProcessScreen> createState() => _PubInProcessScreenState();
}

class _PubInProcessScreenState extends State<PubInProcessScreen> {
  var pubInProcessController = Get.find<PubInProcessController>();
  var brandingController = Get.put(BrandingController());

    TextEditingController searchController = TextEditingController();
  List<PInProcessModel> filteredData = [];

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    pubInProcessController.getPInProcessData();
    filteredData = pubInProcessController.pInProcessModel;
  }

   void filterData(String query) {
    setState(() {
      filteredData = pubInProcessController.pInProcessModel.where((item) {
                          ...
                          Expanded(
                            child: Obx(() {
                              return  pubInProcessController 
                                  ...
                                  : Scrollbar(
                                      controller: pubInProcessController
                                          .scrollController,
                                                                                  ...
                                                                                  Expanded(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: DropdownButtonFormField2(
                                                                                        ...
                                                                                        onChanged: (value) {
                                                                                          pubInProcessController.selectedItemName?.value = value.toString();
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        title:
                                                                            'Shop Name',
                                                                        controller:
                                                                            pubInProcessController.shopNameController,
                                                                        hintText:
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        title:
                                                                            'Contact # 2',
                                                                        controller:
                                                                            pubInProcessController.contact2Controller,
                                                                        hintText:
                                                                            '${filteredData[index].contactNo2}',
                                                                        readOnly:
                                                                            true,
                                                                      ),
                                                                    ),
                                                                            ...
                                                                            Expanded(
                                                                              ...
                                                                              child: IgnorePointer(
                                                                                child: DropdownButtonFormField2(
                                                                                  ...
                                                                                  alignment: Alignment.centerLeft,
                                                                                  items: pubInProcessController.languageList
                                                                                      .map((item) => DropdownMenuItem<String>(
                                                                                            value: item,
                                                                                            alignment: Alignment.centerLeft,
                                                                                            child: AppText(
                                                                                  ...
                                                                                  onChanged: (value) {
                                                                                    pubInProcessController.langValue?.value = value.toString();
                                                                                    //Do something when changing the item if you want.
                                                                                  },
                                                                                  onSaved: (value) {
                                                                                    pubInProcessController.langValue?.value = value.toString();
